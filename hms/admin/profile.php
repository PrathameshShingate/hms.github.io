	 					...
	 					<div class="row">
	 						...
	 						<div class="col-md-6">
	 							...
	 							<form method="post">
	 								...
	 								<input type="submit" name="Change username" class="btn btn-success" value="Change Username">
	 							</form>
	 							...
	 							<form method="post">
	 							 	...
	 							 	<input type="submit" name="update_pass" value="Change Password" class="btn btn-success my-2">
	 							</form> 		
	 						</div>
	 					</div>
	 				</div>
