	 							...
	 							<div class="col-md-6">
                                     ...
                                     if (isset($_POST['update'])) {
                                      ...
                                      ?>
                                   	...
                                   	<form method="post">
                                   		...
                                   		<br>
                                   		<input type="submit" name="update" class="btn btn-success" value="Change Username">
                                   	</form>
                                   	<br><br>
                                    ...
                                    if  ($_POST['change_pass']) {
                                   	...
                                   	<form method="post">
                                   		...
                                   		<input type="submit" name="change_pass" class="btn btn-success my-2" value="Change Password">		
                                   	</form>   	
	 							</div>	
	 						</div>
	 					</div>
